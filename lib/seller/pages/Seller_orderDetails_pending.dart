...
class seller_orderdetails_pending extends StatefulWidget {
  const seller_orderdetails_pending({Key? key}) : super(key: key);

  @override
  _delivery_orderdetailsState createState() => _delivery_orderdetailsState();
}

class _delivery_orderdetailsState extends State<seller_orderdetails_pending> {
  @override
