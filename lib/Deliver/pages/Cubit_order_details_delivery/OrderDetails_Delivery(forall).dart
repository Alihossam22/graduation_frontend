...
class orderdetails_Delivery_forall extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (BuildContext context) => order_Details_delivery_forall_Cubit(),
      child: BlocConsumer<order_Details_delivery_forall_Cubit , order_Details_delivery_forall_States>(
