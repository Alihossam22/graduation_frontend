...
import 'review_de.dart';
import 'myprofile.dart';

class setting_de extends StatefulWidget {
  const setting_de({Key? key}) : super(key: key);

  @override
  _settingState createState() => _settingState();
}

class _settingState extends State<setting_de> {
  @override
                  ...
                  child: Column(
                    children: [
                      ...
                      GestureDetector(
                        ...
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>const myprofile_de()));
                        },
                      ),
                      const SizedBox(
                        height: 20,
                      ...
                      GestureDetector(
                        ...
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>review_de()));
                        },
                      ),
                      const SizedBox(
                        height: 20,
