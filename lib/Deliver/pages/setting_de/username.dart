...
class username_de extends StatelessWidget {
  const username_de({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {

    return BlocProvider(
      create: (BuildContext context) => username_Delivery_Cubit() ,
      child: BlocConsumer <username_Delivery_Cubit ,username_Delivery_States>(
