...
class password_de extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (BuildContext context) =>Password_Delivery_Cubit(),
      child: BlocConsumer<Password_Delivery_Cubit , Password_Delivery_States >(
