...
class myprofile_de extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (BuildContext context) => myprofile_Delivery_Cubit(),
      child: BlocConsumer< myprofile_Delivery_Cubit, myprofile_Delivery_States>(
