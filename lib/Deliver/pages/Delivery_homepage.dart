import 'package:delivery/Deliver/pages/search_Delivery.dart';
import 'package:flutter/material.dart';
import 'package:delivery/Deliver/pages/location_&chose_offer/Delivery_orderDetails.dart';

import 'Cubit_order_details_delivery/OrderDetails_Delivery(forall).dart';

class delivery_homepage extends StatelessWidget {
            ...
            Row(
              children: const [
                ...
                Padding(
                  ...
                  child: Chip(
                    labelPadding: EdgeInsets.all(6.0),
                    label: Text("   Delivery   ",style: TextStyle(color: Colors.white),),
                    backgroundColor: Color(0XFF64314D),
                  ),
                ),
                Padding(
  ...
  Widget buildListIteam (BuildContext context)=>GestureDetector(
    ...
    onTap: (){
      Navigator.push(context, MaterialPageRoute(builder: (context)=>orderdetails_Delivery_forall()));
    },
    child: Padding(
