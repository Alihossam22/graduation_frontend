...
class delivery_orderdetails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (BuildContext context) =>order_Details_chose_search_Cubit(),
      child: BlocConsumer<order_Details_chose_search_Cubit , order_Details_chose_search_States>(
                              ...
                              Row(
                                children: [
                                  ...
                                  GestureDetector(
                                    onTap: (){
                                      Navigator.push(
                                          context, MaterialPageRoute(builder: (context)=>  mainofdelivery())
                                      );
                                    },
                                    child: Container(
                                      height: 50,
